...
class FriendsAdapter(
    private val items : ArrayList<Relationship>,
    private val context: Context) : RecyclerView.Adapter<FriendsAdapter.FriendViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FriendViewHolder {
        return FriendViewHolder(LayoutInflater.from(context).inflate(R.layout.friend_list_item, parent, false))
    }
